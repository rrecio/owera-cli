...
class Developer(BaseAgent):
    ...
    def generate_prompt(self, task: Task, project: Project) -> str:
        ...
        if task.type == "implement":
            ...
            return (
                ...
                f"If authentication is required, use the @auth_required() decorator with parentheses. "
    ...
    def _generate_fallback_route(self) -> str:
        ...
        decorator = "@auth_required()" if auth_required else ""
